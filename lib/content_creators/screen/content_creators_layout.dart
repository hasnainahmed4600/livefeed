...
import 'package:livefeed/content_creators/screen/add_content_card.dart';
import 'package:livefeed/content_creators/screen/content_creators_marketing_header.dart';
import 'package:livefeed/theme.dart';

class ContentCreatorsLayout extends StatelessWidget {
  @override
        ...
        return SingleChildScrollView(
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ContentCreatorsMarketingHeader(),
