      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Padding(
                padding: EdgeInsets.only(top: 16, left: 35, right: 35),
                child: Text(
                  'Verification',
          ...
          Align(
            ...
            child: Padding(
              padding: EdgeInsets.only(top: 9, left: 35, right: 35),
          ...
          Padding(
            padding: EdgeInsets.only(top: 120, left: 9, right: 9),
            child: Text(
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AuthenticationBloc, AuthenticationState>(
      ...
      builder: (context, state) {
        ...
        var country =
            CountryPickerUtils.getCountryByIsoCode(state.user.phoneIsoCode);
        return FittedBox(
          child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      state.user == null
                          ? ''
                          : '+(${state.user.phoneCountryCode}) ${state.user.phoneNumber}',
                      style: LiveFeedTheme.theme.textTheme.bodyText1.copyWith(
                        color: Color.fromRGBO(150, 150, 150, 1),
...
class _ChangeNumberNavigator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: () {
        context.read<LoginBloc>().add(NumberChangeRequested());
      },
    );
  }
}
          ...
          child: PinPut(
            ...
            onChanged: (verificationCode) {
              ...
              if (verificationCode.length >= 6) {
                context.read<LoginBloc>().add(VerificationCodeSubmitted());
              }
            },
            textStyle: TextStyle(
              color: Colors.black,
...
class _ResendButtonActive extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FlatButton(
      ...
      onPressed: () {
        context.read<LoginBloc>().add(NewVerificationCodeRequested());
        SmsAutoFill().listenForCode;
      },
    );
  }
