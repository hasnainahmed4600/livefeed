...
class EditPostCard extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _EditPostCardState(initialHeadline, initialDescription, initialCategory);
}
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            _HeadlineInput(initialHeadline),
            const Padding(padding: EdgeInsets.only(top: 10)),
            _DescriptionInput(initialDescription),
            const Padding(padding: EdgeInsets.only(top: 15)),
            _CategoryMenu(initialCategory),
            const Padding(padding: EdgeInsets.only(top: 15)),
...
class _HeadlineInput extends StatelessWidget {
  ...
  _HeadlineInput(this.defaultValue) : assert(defaultValue.length <= 80);
  @override
  Widget build(BuildContext context) {
...
class _DescriptionInput extends StatelessWidget {
  final String defaultValue;
  final TextEditingController _textController = TextEditingController();
  _DescriptionInput(this.defaultValue) : assert(defaultValue.length <= 2000);
  @override
  Widget build(BuildContext context) {
    _textController.text = defaultValue;
    return TextField(
...
class _CategoryMenu extends StatelessWidget {
  ...
  _CategoryMenu(this.defaultValue);
  @override
  Widget build(BuildContext context) {
    categories.sort();
    return Column(
